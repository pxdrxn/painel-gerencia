...
export default function MetricCard({ value, label, variant = "default" }: MetricCardProps) {
  ...
  const variants = {
    default: "bg-[#1B365D] text-white shadow-[#1B365D]/20 shadow-md",
    highlight: "bg-[#244577] text-white shadow-[#244577]/20 shadow-lg",
  ...
  const labelStyles = {
    default: "text-blue-100 text-xs font-bold tracking-wider uppercase mt-2 text-center",
    highlight: "text-blue-200 text-xs font-bold tracking-wider uppercase mt-2 text-center",
